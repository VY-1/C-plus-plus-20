...
int main(){
    ...
    //std::flush, will flush out the buffer everyline 
    std::cout << "-------std::flush----------" << std::endl;
    std::cout << "This is a std::flush output....." << std::endl << std::flush;
    //After this std::flush, we're sure that at this line, the message has been sent to the terminal
